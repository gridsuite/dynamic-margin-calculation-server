 ...
 */
@Repository
public interface MarginCalculationResultRepository extends JpaRepository<MarginCalculationResultEntity, UUID> {

    Optional<MarginCalculationResultEntity> findByResultUuid(UUID resultUuid);
