...
public class DynamicMarginCalculationResultContext extends AbstractResultContext<DynamicMarginCalculationRunContext> {
    ...
    public static DynamicMarginCalculationResultContext fromMessage(Message<String> message, ObjectMapper objectMapper) {
        Objects.requireNonNull(message);

        // decode the parameters values
        DynamicMarginCalculationParametersInfos parametersInfos;
        try {
            parametersInfos = objectMapper.readValue(message.getPayload(), DynamicMarginCalculationParametersInfos.class);
