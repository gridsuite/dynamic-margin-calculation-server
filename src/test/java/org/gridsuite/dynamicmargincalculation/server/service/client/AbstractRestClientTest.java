 ...
 */
@SpringBootTest
@ContextHierarchy({@ContextConfiguration(classes = {DynamicMarginCalculationApplication.class})})
...
public abstract class AbstractRestClientTest {
    ...
    @BeforeEach
    void setup() {
        // Clear stubs/requests between tests while keeping the same server instance
